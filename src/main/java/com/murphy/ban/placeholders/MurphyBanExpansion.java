...
public class MurphyBanExpansion extends PlaceholderExpansion {
    ...
    public String onRequest(OfflinePlayer player, String identifier) {
        ...
        return switch (identifier.toLowerCase()) {
            ...
            case "banned_reason" -> player == null ? "" : activeBan(db, player.getUniqueId()).map(Punishment::reason).orElse("");
            ...
            case "muted_reason" -> player == null ? "" : activeMute(db, player).map(Punishment::reason).orElse("");
